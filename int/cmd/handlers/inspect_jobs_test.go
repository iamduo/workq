...
func TestInspectJobs(t *testing.T) {
	...
	j := &job.Job{}
	j.ID, _ = job.IDFromBytes([]byte("6ba7b810-9dad-11d1-80b4-00c04fd430c4"))
	j.Name = "q1"
	j.TTR = 1000
	j.TTL = 60000
	j.Payload = []byte("a")
	...
	jb := *j
	jb.ID, _ = job.IDFromBytes([]byte("6ba7b810-9dad-11d1-80b4-00c04fd430c5"))
	...
	expResp = []byte(
		"OK 2\r\n" +
			...
			"state 3\r\n" +
			"created 2016-06-13T14:08:18Z\r\n" +
			"6ba7b810-9dad-11d1-80b4-00c04fd430c5 12\r\n" +
			"name q1\r\n" +
			"ttr 1000\r\n" +
			"ttl 60000\r\n" +
			"payload-size 1\r\n" +
	...
	jc := *j
	jc.ID, _ = job.IDFromBytes([]byte("6ba7b810-9dad-11d1-80b4-00c04fd430c6"))
...
func TestInspectJobsScheduled(t *testing.T) {
	...
	expResp = []byte(
		"OK 2\r\n" +
			...
			"created 2016-06-13T14:08:18Z\r\n" +
			"time 2016-06-13T15:08:18Z\r\n" +
			"6ba7b810-9dad-11d1-80b4-00c04fd430c5 13\r\n" +
			"name q1\r\n" +
			"ttr 1000\r\n" +
			"ttl 60000\r\n" +
			"payload-size 1\r\n" +
